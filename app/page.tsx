...
export default function HomePage() {
  ...
  useEffect(() => {
    if (user?.publicMetadata?.savedSets) {
      setSavedSets(user.publicMetadata.savedSets as SavedLegoSet[])
    }
  }, [user])
  ...
  const handleShare = async (): Promise<string> => {
    ...
    const existingSharedLists = (user.publicMetadata.sharedLists as any[]) || []
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              {user ? (
                <>
                  <SavedItemsSheet savedSets={savedSets} onRemove={handleRemove} onShare={handleShare}>
          ...
          <Card className="mb-8">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Enter a LEGO set ID to find detailed information about any LEGO set.
              </p>
            </CardHeader>
            <CardContent>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  <h3 className="text-lg font-semibold mb-2">Sign in to save your favorite sets</h3>
                  <p className="text-muted-foreground mb-4">
                    Create an account to save LEGO sets and share your collection with others.
                  </p>
                  <Button onClick={() => openSignIn()}>Sign In with Google</Button>
                </div>
              </CardContent>
